...
\title{\vspace{-2cm}\textbf{AI-Driven Sorting Algorithm Optimizer\\[0.4em] Report}\vspace{-10pt}}
\author{CST207 Design and Analysis of Algorithms Group Project}
\date{\vspace{-0.4cm}Academic Session: 2025/09\vspace{-5pt}}
...
\end{lstlisting}
    ...
    \item \textbf{Merge Sort ($O(N \log N)$):} A stable, divide-and-conquer algorithm that guarantees performance but requires $O(N)$ auxiliary space. The algorithm recursively divides the array, then merges sorted subarrays.
...
% \bibitem{knuth1998}
% Knuth, D. E. (1998). 
% \textit{The Art of Computer Programming, Volume 3: Sorting and Searching} (2nd ed.). Addison-Wesley Professional.

% \bibitem{mcilroy1993}
% McIlroy, P. M., Bostic, K., \& McIlroy, M. D. (1993). 
% Engineering a sort function. \textit{Software: Practice and Experience}, 23(11), 1249--1265.
...
% \bibitem{quinlan1986}
% Quinlan, J. R. (1986). 
% Induction of decision trees. \textit{Machine Learning}, 1(1), 81--106.

% \bibitem{wild2015}
% Wild, S., Nebel, M. E., \& Neininger, R. (2015). 
% Average case analysis of Java 7's dual pivot quicksort. \textit{Algorithmica}, 71(4), 848--881.
